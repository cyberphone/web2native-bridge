...
class NFC extends Thread {
    ...
    public void run() {
        try {
            process = Runtime.getRuntime().exec("c:\\github.repositories\\web2native-bridge\\proxy\\install\\NFC.exe");
            ...
            NativeClient.logger.log(Level.SEVERE, "NFC errors", e);
            System.exit(3);
        }
    }
