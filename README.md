...
* The Web2Native Bridge Chrome browser extension is fully generic

### Installation
1. Clone the <code>web2native-bridge</code> project or just download the ZIP via GitHub to any free directory
2. Install the Chrome extension available in <code>extension/src</code> as described in https://developer.chrome.com/extensions/getstarted#unpacked
