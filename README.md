...
2. Install the Chrome browser extension available in <code>extension/release</code> as described in https://developer.chrome.com/extensions/getstarted#unpacked
