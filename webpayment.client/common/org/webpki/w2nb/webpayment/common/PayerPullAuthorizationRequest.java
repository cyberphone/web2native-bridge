...
public class PayerPullAuthorizationRequest extends EncryptedAuthorizationRequest {
    
    String authUrl;

    public PayerPullAuthorizationRequest(JSONObjectReader rd) throws IOException {
        super(Messages.parseBaseMessage(Messages.PAYER_PULL_AUTH_REQ, rd).getObject(AUTH_DATA_JSON));
