...
public class AuthorityObject implements BaseProperties {
    ...
    public static JSONObjectWriter encode(String authorityUrl,
        ...
        return Messages.createBaseMessage(Messages.AUTHORITY_OBJECT)
    ...
    public AuthorityObject(JSONObjectReader rd) throws IOException {
        Messages.parseBaseMessage(Messages.AUTHORITY_OBJECT, rd);
