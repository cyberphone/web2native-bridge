...
public class PayeeAccountDescriptor implements BaseProperties {
    String type;              // URI
    ...
    public PayeeAccountDescriptor(String type, String id, String[] optionalFields) throws IOException {
        this.type = type;
        this.id = id;
    ...
    public PayeeAccountDescriptor(String type, String id) throws IOException {
        this(type, id, new String[0]);
    }

    public PayeeAccountDescriptor(JSONObjectReader rd) throws IOException {
    ...
    JSONObjectWriter write() throws IOException {
